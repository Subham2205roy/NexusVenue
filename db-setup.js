...
const connectionString = 'postgresql://postgres:Subham2205%40@db.ymirjgjfgeoyrjzeffbj.supabase.co:5432/postgres';
...
const run = async () => {
    ...
    `);
        ...
        COMMIT;
      `);
            console.log('Realtime publication correctly set up.');
        } catch (e) {
            console.log('Realtime issue (might be default supabase settings):', e.message);
        }

        console.log('Schema successfully deployed to Supabase and initial data seeded.');
    } catch (err) {
